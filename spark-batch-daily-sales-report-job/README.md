...
* `ksoot.job.correlation-id`:- The Job Correlation Id used to track job status or stop a running job from [`spark-job-service` Stop Job API](../spark-job-service/README.md#stop-spark-job) REST API.
